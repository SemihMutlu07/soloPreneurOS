    ...
    >
      <div className="flex items-center gap-2 mb-3">
        <input
          ...
          className="flex-1 bg-surface-elevated/30 text-sm text-text-primary placeholder:text-text-muted rounded-lg px-3 py-2 border border-border focus:outline-none focus:border-accent-primary/30 transition-colors"
        />
      </div>
          ...
          return (
            ...
            >
              <input
                ...
                className="w-3.5 h-3.5 rounded border-border-strong accent-accent-primary shrink-0"
              />
      ...
      {analysis && (
        <div className="mt-3 space-y-2.5">
          <div className="p-3 rounded-xl bg-surface-elevated/30 border-l-2 border-l-accent-primary">
            <h4 className="text-[11px] font-semibold text-accent-primary mb-1.5 uppercase tracking-wide">
              Agent&apos;s take
            </h4>
              ...
              <ol className="space-y-0.5">
                {analysis.suggestedOrder.map((item, i) => (
                  <li key={i} className="text-[13px] text-text-secondary leading-relaxed">
                    <span className="text-accent-primary font-mono mr-1.5">{i + 1}.</span>
                    {item}
                  </li>
                ))}
              </ol>
