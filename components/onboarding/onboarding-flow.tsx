    ...
    return (
      <div className="fixed inset-0 z-50 bg-bg flex items-center justify-center">
        <div className="max-w-md w-full mx-4 text-center">
          <Sparkles className="w-8 h-8 text-accent-teal mx-auto mb-4 animate-gentle-spin" />
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    agent.active
                      ? "bg-surface border-accent-teal/20"
                ...
                >
                  {IconComp && (
                    <IconComp
                      className={cn(
                        "w-4 h-4",
                        agent.active ? "text-accent-teal" : "text-text-muted"
                      )}
                    />
                  )}
                  <span
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 rounded-xl bg-surface-elevated border border-border text-gray-100 text-sm placeholder:text-text-muted focus:outline-none focus:border-accent-teal/50 transition-colors"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-text-secondary mb-1.5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2.5 rounded-xl bg-surface-elevated border border-border text-gray-100 text-sm placeholder:text-text-muted focus:outline-none focus:border-accent-teal/50 transition-colors resize-none"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-text-secondary mb-1.5">
          ...
          {step === 4 && (
            <div className="animate-fade-in">
              ...
              <p className="text-text-secondary text-sm mb-6">
                ...
                <span className="ml-2 text-accent-teal font-mono">
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={cn(
                          "text-sm font-medium",
                          selected ? "text-accent-teal" : "text-gray-100"
                        )}
                      >
                        {pp.label}
                      </span>
          ...
          <div className="flex items-center justify-between mt-8 pt-5 border-t border-border">
            ...
            <button
              ...
              className={cn(
                ...
                canProceed()
                  ? "bg-accent-teal text-bg hover:bg-accent-teal/90"
